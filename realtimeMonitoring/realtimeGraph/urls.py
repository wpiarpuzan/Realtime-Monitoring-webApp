...
urlpatterns = [
    ...
    path("mapJsonRowsSamples/", get_map_json_rows_samples, name="mapJsonRowsSamples"),
    path("mapJsonRowsSamples/<str:measure>", get_map_json_rows_samples, name="mapJsonRowsSamples"),
