...
# Json con datos de cantidad de registros en la tabla vs cantidad de datos
def get_map_json_rows_samples(request, **kwargs):
    ...
    data = []
    #Contando las filas y las muestras de cada ubicación para la medida seleccionada en el rango de fechas indicado
    total_rows = 0
    total_samples = 0
    ...
    data_result["samples"] = total_samples
